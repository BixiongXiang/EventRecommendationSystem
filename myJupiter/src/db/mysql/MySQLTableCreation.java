...
/**
 * this class is not related to server function
 * 
 * this class is only to recreate the table in db and set it to empty and inital a user 1111
 * we have table:
 * 		users
 * 		items
 * 		favorite item(history)
 * 		categories
 * 		
 * */
public class MySQLTableCreation {
	...
	public static void main(String[] args) {
		try {
			...
			String sql = "DROP TABLE IF EXISTS categories"; //set sql to drop table
			statement.executeUpdate(sql);  // run sql
			...
			// Test: insert fake user 1111/ pwd(encoded): 3229c1097c00d497a0fd282d586be050  (2222)
			sql = "INSERT INTO users VALUES('1111', '3229c1097c00d497a0fd282d586be050', 'Jon', 'Snow')";
			statement.executeUpdate(sql);
