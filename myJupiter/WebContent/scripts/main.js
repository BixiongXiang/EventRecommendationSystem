/* this is the js for connecting the server to do frontend active
 * main.js
...
(function() {
	  ...
	  //set a default location, later will load real one again
	  var lng = -122.08;
	  var lat = 37.38;
	  ...
	  /**
		 * Session
		 */
	  // check if valid, if yes show valid form
	  function validateSession() {
	    ...
	    // make AJAX call
	    // so browser will not wait for response using ajax
	    ajax('GET', url, req,
	  ...
	  // to change to normal item display
	  ...
	  // functions to show/ hide item, remove it from taking place
	  ...
	  function login() {
	    ...
	    // encoding: use md5 hash function to encode to a 128bit hash code,
		// 128/4=32 hex
	    password = md5(username + md5(password));

	    // The request parameters
	    var url = './login';
	    // build JSON string from {} JS Object(a hash map), [] is JS array
	    var req = JSON.stringify({
	      user_id : username,
	      password : password,
	    });
	  ...
	  function ajax(method, url, data, successCallback, errorCallback) {
	    ...
	    //do ajax call, request to server
	  ...
	  /**
		 ...
		 * Vegetarian
		 * </p>
		 * <div class="stars"> <i class="fa fa-star"></i> <i class="fa
		 * fa-star"></i> <i class="fa fa-star"></i> </div> </div>
